...
public class HibernateTemplate {
	...
	public static List<Orders> getObjectListByQuery(String query)
	{
	...
	public static List<Object> getObjectListByName(Class c, String columName, double value) {
		Session session=sessionFactory.openSession();
		  Criteria criteria = session.createCriteria(c);
			Criterion nameCriterion = Restrictions.eq(columName, value);
			criteria.add(nameCriterion);
	...
	public static List<Object> getObjectListByName(Class c, String columName, int value) {
		Session session=sessionFactory.openSession();
		  Criteria criteria = session.createCriteria(c);
			Criterion nameCriterion = Restrictions.eq(columName, value);
			criteria.add(nameCriterion);
